...
The details are documented in the [configuration reference](../setup/config.md).
...
By default distributed tracing is disabled but it can be [configured](../setup/config.md)
