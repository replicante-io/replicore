...
CREATE TABLE IF NOT EXISTS store_orchestrate_report(
  -- Orchestrate report object as a JSON blob.
...
CREATE TABLE IF NOT EXISTS store_cluster_shard(
  -- Shard object as a JSON blob.
  shard TEXT NOT NULL,
